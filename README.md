# `PETSc_jll.jl` (v3.20.5+0)

[![deps](https://juliahub.com/docs/PETSc_jll/deps.svg)](https://juliahub.com/ui/Packages/General/PETSc_jll/)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/dfc6fb92f7c4d6692e4f5867c038138336c344fa/P/PETSc/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* compressed archive: https://web.cels.anl.gov/projects/petsc/download/release-snapshots/petsc-3.20.5.tar.gz (SHA256 checksum: `fb4e637758737af910b05f30a785245633916cd0a929b7b6447ad1028da4ea5a`)
* files in directory, relative to originating `build_tarballs.jl`: [`./bundled`](https://github.com/JuliaPackaging/Yggdrasil/tree/dfc6fb92f7c4d6692e4f5867c038138336c344fa/P/PETSc/bundled)
